...
if [ -f $data/score_sclite ]; then # use sclite scoring.
  echo "$data/score_sclite exists: using local/score_sclite.sh"
  eval local/score_sclite.sh $orig_args
else
  echo "$data/score_sclite does not exist: using local/score_basic.sh"
