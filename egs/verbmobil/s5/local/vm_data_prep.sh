...
cat $dir/data_uttId_uttP_test_tmp.flist | sort |uniq > $dir/data_uttId_uttP_test.flist
rm $dir/data_uttId_uttP_train_tmp.flist $dir/data_uttId_uttP_test_tmp.flist
